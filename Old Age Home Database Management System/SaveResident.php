...
$sql="insert into resident values(null,'$r_off_id','$r_name','$r_fath_name','$r_moth_name','$r_aadhar_no','$r_dob','$r_age','$r_bir_place','$r_religion','$r_caste','$r_profession','$r_moth_tongue','$r_marital_status','$r_widow','$r_permt_add','$r_hw_name_phno','$r_bs_name_phno','$r_sd_name_phno','$r_gn_add','$r_gn_phno','$r_cremation','$r_staying')";
mysql_query($sql);
?>
<script type="text/javascript" language="php">
alert("New Resident Details inseted successfully");
