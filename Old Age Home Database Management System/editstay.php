...
<?php
$s_id =$_GET['s_id'];
$sql="select * from stay where s_id ='$s_id'";
$res=mysql_query($sql);
$row=mysql_fetch_array($res);
?>
<form name="form1" method="post" action="updatestay.php">
  <table width="200" border="5" align="center">
    <tr>
      <th scope="row">INDEPENDENT</th>
      <td>
	  <input name="s_id" type="hidden" id="s_id" value="<?php echo $row['s_id'];?>" />
	   <script>
        function p1()
        {
	  ...
	  <input type="text" name="s_mode1" id="s_mode1" value="<?php echo $row['s_mode1'];?>" required x-moz-errormessage="Please enter this field" onblur="p1()"></td>
    </tr>
    <tr>
	  ...
	  <input type="text" name="s_mode2" id="s_mode2" value="<?php echo $row['s_mode2'];?>"required x-moz-errormessage="Please enter this field" onblur="p2()" ></td>
    </tr>
    <tr>
	  ...
	  <input type="text" name="s_mode3" id="s_mode3" value="<?php echo $row['s_mode3'];?>" required x-moz-errormessage="Please enter this field" onblur="p3()"></td>
    </tr>
    <tr>
