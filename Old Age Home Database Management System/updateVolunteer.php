...
$sql="update volunteer set v_off_id='$v_off_id',v_name='$v_name',v_fh_name='$v_fh_name',v_m_name='$v_m_name',v_dob='$v_dob',v_age='$v_age',v_bir_place='$v_bir_place',v_religion='$v_religion',v_caste='$v_caste',v_profession='$v_profession',v_moth_toungue='$v_moth_toungue',v_permt_add='$v_permt_add',v_phno='$v_phno',v_aadhar_no='$v_aadhar_no',v_date_join='$v_date_join',v_date_leave='$v_date_leave',v_salary='$v_salary',v_staying='$v_staying' where v_id='$v_id'";
mysql_query($sql);
?>
